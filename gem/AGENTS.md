...
`docs/` symlinks straight to these `*_controller.js` files (`docs/app/javascript/controllers/ruby_ui/`) — no independent copy. Editing a controller here is editing what the live docs site serves too.
