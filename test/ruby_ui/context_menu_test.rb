...
module RubyUI
  class ContextMenuTest < ComponentTest
    def test_render_with_all_items
      output = phlex do
        RubyUI.ContextMenu do
          RubyUI.ContextMenuTrigger(class: 'flex h-[150px] w-[300px] items-center justify-center rounded-md border border-dashed text-sm') do
            'Right click here'
          end
