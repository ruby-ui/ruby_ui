    ...
    class Chart < Views::Base
      def view_template
        div(class: 'max-w-2xl mx-auto w-full py-10 space-y-10') do
          ...
          render Docs::VisualCodeExample.new(title: 'Pie Chart', description: 'Setting custom background color',
                                             context: self) do
            <<~RUBY
              options = {
                type: 'pie',
      ...
      def components
        [
          ::Docs::ComponentStruct.new(name: 'ChartController',
                                      source: 'https://github.com/PhlexUI/phlex_ui_stimulus/blob/main/controllers/chart_controller.js', built_using: :stimulus),
          ::Docs::ComponentStruct.new(name: 'Chart',
                                      source: 'https://github.com/PhlexUI/phlex_ui/blob/main/lib/phlex_ui/chart.rb', built_using: :phlex)
        ]
      end
    end
  end
