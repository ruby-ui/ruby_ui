...
module Views
  module Docs
    class Table < Views::Base
      ...
      def users
        [
          User.new(avatar_url: 'https://avatars.githubusercontent.com/u/246692?v=4', name: 'Joel Drapper',
                   username: 'joeldrapper', commits: 404),
          User.new(avatar_url: 'https://avatars.githubusercontent.com/u/33979976?v=4', name: 'Alexandre Ruban',
                   username: 'alexandreruban', commits: 16),
          User.new(avatar_url: 'https://avatars.githubusercontent.com/u/77887?v=4', name: 'Will Cosgrove',
                   username: 'willcosgrove', commits: 12),
          User.new(avatar_url: 'https://avatars.githubusercontent.com/u/3025661?v=4', name: 'Stephann V.',
                   username: 'stephannv', commits: 8),
          User.new(avatar_url: 'https://avatars.githubusercontent.com/u/6411752?v=4', name: 'Marco Roth',
                   username: 'marcoroth', commits: 8)
        ]
      end
