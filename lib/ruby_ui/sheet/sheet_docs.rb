...
module Views
  module Docs
    class Sheet < Views::Base
      def view_template
        component = 'Sheet'

        div(class: 'max-w-2xl mx-auto w-full py-10 space-y-10') do
          render Docs::Header.new(title: 'Sheet',
                                  description: 'Extends the Sheet component to display content that complements the main content of the screen.')
          ...
          render Docs::VisualCodeExample.new(title: 'Side',
                                             description: 'Use the side property to indicate the edge of the screen where the component will appear.', context: self) do
            <<~RUBY
