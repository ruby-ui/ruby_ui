...
module Views
  module Docs
    class NativeSelect < Views::Base
      def view_template
        component = 'NativeSelect'

        div(class: 'max-w-2xl mx-auto w-full py-10 space-y-10') do
          render Docs::Header.new(title: 'Native Select',
          ...
          render Docs::VisualCodeExample.new(title: 'Groups',
                                             description: 'Use NativeSelectGroup to organize options into categories.', context: self) do
            <<~RUBY
              div(class: "grid w-full max-w-sm items-center gap-1.5") do
                NativeSelect do
          ...
          render Docs::VisualCodeExample.new(title: 'Disabled',
                                             description: 'Add the disabled attribute to the NativeSelect component to disable the select.', context: self) do
            <<~RUBY
              div(class: "grid w-full max-w-sm items-center gap-1.5") do
          ...
          render Docs::VisualCodeExample.new(title: 'Invalid', description: 'Use aria-invalid to show validation errors.',
                                             context: self) do
            <<~RUBY
              div(class: "grid w-full max-w-sm items-center gap-1.5") do
