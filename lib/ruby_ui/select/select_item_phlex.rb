...
module RubyUI
  class SelectItem < Base
    ...
    def view_template(&)
      div(**attrs) do
        svg(xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", class: "invisible group-aria-selected:visible mr-2 h-4 w-4 flex-none", stroke_width: "2", stroke_linecap: "round", stroke_linejoin: "round") do |s|
