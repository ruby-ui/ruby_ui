...
module RubyUI
  class ComboboxTrigger < Base
    ...
    def view_template(&)
      button(**attrs) do
        span(class: "truncate", data_ruby_ui__combobox_target: "triggerContent") do
          placeholder
        end

        svg(xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", class: "ml-2 h-4 w-4 shrink-0 opacity-50", stroke_width: "2", stroke_linecap: "round", stroke_linejoin: "round") do |s|
