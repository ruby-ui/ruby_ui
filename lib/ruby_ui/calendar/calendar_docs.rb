...
module Views
  module Docs
    class Calendar < Views::Base
      def view_template
        component = 'Calendar'
        div(class: 'max-w-2xl mx-auto w-full py-10 space-y-10') do
          render Docs::Header.new(title: 'Calendar',
          ...
          render Docs::VisualCodeExample.new(title: 'Format date', description: 'Format dates with date-fns',
                                             context: self) do
            <<~RUBY
              div(class: 'space-y-4') do
