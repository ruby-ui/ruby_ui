    ...
    class DropdownMenu < Views::Base
      def view_template
        ...
        div(class: 'max-w-2xl mx-auto w-full py-10 space-y-10') do
          render Docs::Header.new(title: 'Dropdown Menu',
          ...
          render Docs::VisualCodeExample.new(title: 'Placement',
                                             description: "If the DropdownMenu conflicts with edge, it will auto-adjust it's placement", context: self) do
            <<~RUBY
